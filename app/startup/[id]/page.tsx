...
const startups = [
    {
        id: '1',
        name: 'TechInnovate',
        description: 'Revolutionizing AI for small businesses',
        fullDescription:
            'TechInnovate is at the forefront of bringing advanced AI solutions to small businesses. Our platform democratizes access to cutting-edge technology, enabling small enterprises to compete with larger corporations in terms of efficiency and innovation.',
    },
    {
        id: '2',
        name: 'GreenGrowth',
        description: 'Sustainable solutions for urban farming',
        fullDescription:
            'GreenGrowth is transforming urban spaces into productive, sustainable farms. Our vertical farming technology and smart irrigation systems make it possible to grow fresh produce in the heart of cities, reducing food miles and increasing access to nutritious food.',
    },
    {
        id: '3',
        name: 'FinFlow',
        description: 'Streamlining financial processes for startups',
        fullDescription:
